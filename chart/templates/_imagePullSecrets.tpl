...
*/}}
{{- define "omar-basemap.imagePullSecrets" -}}
  {{/*
  ...
  */}}
  ...
  {{- if .Values.generatedImagePullSecret -}}
    {{- if .Values.generatedImagePullSecret.create -}}
      {{- $secrets = (append $secrets (.Values.generatedImagePullSecret.name | default (include "omar-basemap.fullname" .))) }}
    {{- end -}}
  {{- end -}}
...
{{- define "omar-basemap.generateImagePullSecret" }}
